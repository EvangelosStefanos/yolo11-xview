...
# imgz + batch: 128 + 128 (256?) / 256 + 32 / 512 + 4
timer.set()
model.train(
    data="/datasets/xview_chipped/xview.yaml", epochs=100, imgsz=512, batch=4, workers=1, fraction=1.0, project="latest", exist_ok=True, classes=classes,
    hsv_h=0.2, hsv_s=0.2, hsv_v=0.2, degrees=45, erasing=0.2, crop_fraction=0.8, multi_scale=True,
)
